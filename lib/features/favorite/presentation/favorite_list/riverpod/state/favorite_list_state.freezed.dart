...
/// @nodoc
abstract class _$$_FavoriteListStateCopyWith<$Res>
    implements $FavoriteListStateCopyWith<$Res> {
  factory _$$_FavoriteListStateCopyWith(_$_FavoriteListState value,
          $Res Function(_$_FavoriteListState) then) =
      __$$_FavoriteListStateCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {List<Photo> wallpapers,
...
/// @nodoc
class __$$_FavoriteListStateCopyWithImpl<$Res>
    extends _$FavoriteListStateCopyWithImpl<$Res, _$_FavoriteListState>
    implements _$$_FavoriteListStateCopyWith<$Res> {
  __$$_FavoriteListStateCopyWithImpl(
      _$_FavoriteListState _value, $Res Function(_$_FavoriteListState) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$_FavoriteListState(
      wallpapers: null == wallpapers
          ? _value._wallpapers
          : wallpapers // ignore: cast_nullable_to_non_nullable
              as List<Photo>,
...
class _$_FavoriteListState implements _FavoriteListState {
  _$_FavoriteListState(
  ...
  @override
  String toString() {
    return 'FavoriteListState(wallpapers: $wallpapers, page: $page, isPaginating: $isPaginating, isFinishedPaginating: $isFinishedPaginating)';
  }
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$_FavoriteListStateCopyWith<_$_FavoriteListState> get copyWith =>
      __$$_FavoriteListStateCopyWithImpl<_$_FavoriteListState>(
          this, _$identity);
}

abstract class _FavoriteListState implements FavoriteListState {
  factory _FavoriteListState(
      {final List<Photo> wallpapers,
      final int page,
      final bool isPaginating,
      final bool isFinishedPaginating}) = _$_FavoriteListState;
